...
const INTENT_KEYWORDS: Array<{ intent: Intent; keywords: string[] }> = [
    ...
    {
        // Descriptive questions about bureau/committee duties (not member names).
        ...
        keywords: [
            // Mission / role / duty / function of المكتب الوطني
            "مهام المكتب الوطني", "اختصاصات المكتب الوطني", "دور المكتب الوطني",
            "وظائف المكتب الوطني", "ما هي مهام المكتب الوطني",
            // Mission / role / duty / function of other union bodies
            ...
            "مهام اللجنة الإدارية", "اختصاصات اللجنة الإدارية", "دور اللجنة الإدارية",
