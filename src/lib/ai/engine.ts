  ...
  const knowledgeSection =
    context.knowledgeBase.length > 0
      ? context.knowledgeBase
        ...
        .map(
          (k) =>
            `[${k.category}] ${k.title}:\n${k.content.length > 2500 ? k.content.substring(0, 2500) + "..." : k.content}`
        )
        .join("\n\n---\n\n")
...
- بدل "زبون/عميل" → **"المنخرط"** أو **"المناضل"** أو **"الزميل/الزميلة"**
- للترحيب: "مرحباً بك زميلي/زميلتي"، "أهلاً بك في الجامعة الوطنية للتعليم"
